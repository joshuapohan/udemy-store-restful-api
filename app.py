...
app.secret_key  = 'joshua' # app.config['JWT_SECRET_KEY']
api = Api(app)

jwt = JWTManager(app) # doesnt' create auth end point

@jwt.user_claims_loader
def add_claims_to_jwt(identity):
	if identity == 1: #instead of hard coding, should read from config file or a database
